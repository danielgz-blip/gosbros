...
## Corpus Check
- 45 files · ~90,813 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 161 nodes · 191 edges · 20 communities (14 shown, 6 thin omitted)
...
3. `GOSBROS` - 9 edges
4. `Hero_Placeholder image - 1024x1024 placeholder graphic for GOSBROS portfolio site` - 6 edges
5. `scripts` - 5 edges
6. `Website Builder Skill` - 5 edges
...
- `Hero_Placeholder image - 1024x1024 placeholder graphic for GOSBROS portfolio site` --references--> `AdminPage - Local CMS with hero image upload and project content builder`  [EXTRACTED]
  gosbrosters.com/public/Hero_Placeholder.jpg → gosbrosters.com/src/app/admin/page.tsx
...
Cohesion: 0.08
Nodes (23): dependencies, framer-motion, next, react, react-dom, @vercel/blob, devDependencies, eslint (+15 more)
...
## Knowledge Gaps
- **82 isolated node(s):** `@opencode-ai/plugin`, `eslintConfig`, `nextConfig`, `name`, `version` (+77 more)
...
- **What is the exact relationship between `Hero_Placeholder image - 1024x1024 placeholder graphic for GOSBROS portfolio site` and `Hero.tsx - Hero section component with Vimeo video background and animated text`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What connects `@opencode-ai/plugin`, `eslintConfig`, `nextConfig` to the rest of the system?**
